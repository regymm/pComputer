...
#
# Generated by Vivado on Wed Sep 30 17:50:21 CST 2020
...
#    "/home/petergu/MyHome/pComputer/pCPU/pCPU.srcs/sources_1/ip/distram/distram.xci"
#    "/home/petergu/MyHome/pComputer/pCPU/pCPU.srcs/sources_1/ip/bootrom/bootrom.xci"
#    "/home/petergu/MyHome/pComputer/pCPU/pCPU.srcs/sources_1/ip/clock_wizard/clock_wizard.xci"
...
#    "/home/petergu/MyHome/pComputer/pCPU/pCPU.srcs/sources_1/new/pcpu_main.v"
#    "/home/petergu/MyHome/pComputer/pCPU/pCPU.srcs/sources_1/new/keyboard.v"
#    "/home/petergu/MyHome/pComputer/pCPU/pCPU.srcs/sources_1/bd/ps_design/hdl/ps_design_wrapper.v"
...
set_property -name "webtalk.activehdl_export_sim" -value "111" -objects $obj
set_property -name "webtalk.ies_export_sim" -value "111" -objects $obj
set_property -name "webtalk.modelsim_export_sim" -value "111" -objects $obj
set_property -name "webtalk.questa_export_sim" -value "111" -objects $obj
set_property -name "webtalk.riviera_export_sim" -value "111" -objects $obj
set_property -name "webtalk.vcs_export_sim" -value "111" -objects $obj
set_property -name "webtalk.xsim_export_sim" -value "111" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../ip_repo/psddr_1.0"] [file normalize "$origin_dir/../../Vivado/Digilent"]" $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/pCPU.srcs/sources_1/ip/distram/distram.xci" ]\
 [file normalize "${origin_dir}/pCPU.srcs/sources_1/ip/bootrom/bootrom.xci" ]\
 [file normalize "${origin_dir}/pCPU.srcs/sources_1/ip/clock_wizard/clock_wizard.xci" ]\
 ...
 [file normalize "${origin_dir}/pCPU.srcs/sources_1/new/pcpu_main.v" ]\
 [file normalize "${origin_dir}/pCPU.srcs/sources_1/new/keyboard.v" ]\
 [file normalize "${origin_dir}/pCPU.srcs/sources_1/bd/ps_design/hdl/ps_design_wrapper.v" ]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "pcpu_main" -objects $obj
...
if { [get_files video.v] == "" } {
  import_files -quiet -fileset sources_1 /home/petergu/MyHome/pComputer/pCPU/pCPU.srcs/sources_1/new/video.v
}
...
# module references:
# cpu_multi_cycle, gpio, interrupt_unit, mmapper, mmu, sdcard, sdmm, timer_interrupt, uart, video
  ...
  set_property -dict [ list \
   CONFIG.FREQ_HZ {25000000} \
 ] [get_bd_pins /video_0/TMDSn_clock]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {25000000} \
 ] [get_bd_pins /video_0/TMDSp_clock]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {62500000} \
   CONFIG.CLK_DOMAIN {/clk_wiz_0_clk_out1} \
 ] [get_bd_pins /video_0/clk]
  ...
  connect_bd_net -net clk_wiz_0_clk_hdmi [get_bd_pins clk_wiz_0/clk_hdmi] [get_bd_pins video_0/clk_pix]
  connect_bd_net -net clk_wiz_0_clk_hdmi_10x [get_bd_pins clk_wiz_0/clk_hdmi_10x] [get_bd_pins video_0/clk_tmds]
  ...
  connect_bd_net -net cpu_multi_cycle_0_ring [get_bd_pins cpu_multi_cycle_0/ring] [get_bd_pins mmu_0/ring]
  connect_bd_net -net cpu_multi_cycle_0_we [get_bd_pins cpu_multi_cycle_0/we] [get_bd_pins mmu_0/vwe]
  connect_bd_net -net debounce_0_o_state [get_bd_pins gpio_0/sw] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net main_memory_spo [get_bd_pins main_memory/spo]
  ...
  connect_bd_net -net mmapper_0_irq [get_bd_pins mmapper_0/irq] [get_bd_pins mmu_0/pirq]
  ...
  connect_bd_net -net mmapper_0_mainm_a [get_bd_pins main_memory/a]
  connect_bd_net -net mmapper_0_mainm_d [get_bd_pins main_memory/d]
  connect_bd_net -net mmapper_0_mainm_we [get_bd_pins main_memory/we]
  ...
  connect_bd_net -net mmapper_0_video_a [get_bd_pins mmapper_0/video_a] [get_bd_pins video_0/a]
  connect_bd_net -net mmapper_0_video_d [get_bd_pins mmapper_0/video_d] [get_bd_pins video_0/d]
  connect_bd_net -net mmapper_0_video_we [get_bd_pins mmapper_0/video_we] [get_bd_pins video_0/we]
  ...
  connect_bd_net -net sysclk_1 [get_bd_pins clk_wiz_0/clk_main] [get_bd_pins cpu_multi_cycle_0/clk] [get_bd_pins gpio_0/clk] [get_bd_pins interrupt_unit_0/clk] [get_bd_pins main_memory/clk] [get_bd_pins mmu_0/clk] [get_bd_pins sdcard_0/clk] [get_bd_pins sdmm_0/clk] [get_bd_pins timer_interrupt_0/clk_125M] [get_bd_pins uart_0/clk] [get_bd_pins video_0/clk]
  connect_bd_net -net sysclk_2 [get_bd_ports sysclk] [get_bd_pins clk_wiz_0/clk_in1]
  ...
  connect_bd_net -net video_0_TMDSn [get_bd_ports TMDSn] [get_bd_pins video_0/TMDSn]
  connect_bd_net -net video_0_TMDSn_clk [get_bd_ports TMDSn_clock] [get_bd_pins video_0/TMDSn_clock]
  connect_bd_net -net video_0_TMDSp [get_bd_ports TMDSp] [get_bd_pins video_0/TMDSp]
  connect_bd_net -net video_0_TMDSp_clk [get_bd_ports TMDSp_clock] [get_bd_pins video_0/TMDSp_clock]
  connect_bd_net -net video_0_spo [get_bd_pins mmapper_0/video_spo] [get_bd_pins video_0/spo]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins cpu_multi_cycle_0/rst] [get_bd_pins gpio_0/rst] [get_bd_pins interrupt_unit_0/rst] [get_bd_pins mmu_0/rst] [get_bd_pins sdcard_0/rst] [get_bd_pins sdmm_0/rst] [get_bd_pins timer_interrupt_0/rst] [get_bd_pins uart_0/rst] [get_bd_pins video_0/rst] [get_bd_pins xlslice_0/Dout]
...
# Proc to create BD ps_design
proc cr_bd_ps_design { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name ps_design
  ...
  # Create instance: psddr_0, and set properties
  set psddr_0 [ create_bd_cell -type ip -vlnv user.org:user:psddr:1.0 psddr_0 ]
  ...
  connect_bd_intf_net -intf_net psddr_0_M00_AXI [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins psddr_0/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins psddr_0/m00_axi_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins psddr_0/m00_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces psddr_0/M00_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_DDR_LOWOCM] SEG_processing_system7_0_GP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces psddr_0/M00_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_IOP] SEG_processing_system7_0_GP0_IOP
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces psddr_0/M00_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_QSPI_LINEAR] SEG_processing_system7_0_GP0_QSPI_LINEAR
...
# End of cr_bd_ps_design()
cr_bd_ps_design ""
set_property REGISTERED_WITH_MANAGER "1" [get_files ps_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files ps_design.bd ] 
